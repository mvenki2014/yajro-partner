...
export function NextPoojaCard({ poojaName, time, customerName, address, packageName = "Standard" }: NextPoojaCardProps) {
  return (
    <Card className="mb-4 relative overflow-hidden p-3.5 pt-3 bg-gradient-to-br from-white to-[#FFF9F2] border-slate-200/60 shadow-md rounded-2xl hover:z-20">
      ...
      <div className="relative z-10">
        ...
        {packageName && (
          <div className="inline-flex px-2 py-0.5 rounded-full bg-orange-100 text-[#FF9933] text-[10px] font-black uppercase tracking-tight mb-3">
            {packageName}
          </div>
        )}
